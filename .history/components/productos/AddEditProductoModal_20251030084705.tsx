...
interface AddEditProductoModalProps {
  ...
  onSave: (
    data: Omit<
      GlobalProduct,
      "product_id" | "categoria_nombre" | "current_stock_total"
    >,
    id?: string
  ) => Promise<void>;
      ...
      >
        ...
        >
          ...
          <div className="col-span-2">
            ...
            >
              {isEditMode && (
                <option value={category_id} disabled>
                  {productoToEdit?.categoria_nombre} (No Editable)
                </option>
              )}
              {!isEditMode && (
            ...
            {isEditMode && (
              <p className="text-xs text-red-500 mt-1">
                La categoría no se puede cambiar en un producto existente.
              </p>
            )}
          </div>
          ...
          <div className="col-span-2">
            ...
            <input
              ...
              required
              disabled={isSaving}
              className="mt-1 w-full rounded-lg disabled:opacity-70"
            />
          </div>

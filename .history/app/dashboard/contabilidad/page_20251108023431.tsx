...
import { Poliza, PolizaFilters } from '@/lib/data';

// Importar componentes
import PolizasStats from '@/components/contabilidad/polizasStats';
import PolizasFiltersComponent from '@/components/contabilidad/polizasFiltersolizasFilters';
import PolizasTable from '@/components/contabilidad/polizasTableolizasTable';
import PolizasPagination from '@/components/contabilidad/polizasStatsolizasPagination';
...
export default function ContabilidadPage() {
  ...
  const handleViewPoliza = (id: number) => {
    ...
    // Aquí abrirás un modal con los detalles
  };
